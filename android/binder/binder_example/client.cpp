...
protected:
	virtual status_t onTransact( uint32_t code, const Parcel& data, Parcel* reply, uint32_t gs = 0)
	{
...
int main()
{
	...
	sp<IBinder> b = sm->getService(String16("media.hello")); 
	...
	int ret = b->transact(4, in1, &out1, 0); 
